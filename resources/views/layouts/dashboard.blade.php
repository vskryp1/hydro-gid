...
<head>
    ...
    <!-- Map api -->
    <script src="https://maps.googleapis.com/maps/api/js?key={{env('GOOGLE_API_KEY')}}&libraries=places&language={{ session('lang')?: 'en' }}"></script>
</head>
<!-- Meta Pixel Code -->
<script>
...
<body style="background-color: #eaeef2;">
    <div id="app">
        <v-app>
            <dashboard-app :default-data="{{ json_encode($default_data) }}">
