...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/backend/css/products.css') }}">
  <link rel="stylesheet" href="{{ asset('vendor/file-manager/css/file-manager.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/backend/css/cropper_dropzone.css') }}">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/{{ Request::path() }}/upload" role='form' id='uploadForm' name='uploadForm' method='post' enctype='multipart/form-data' class="dropzone">
...
<script src="{{ asset('assets/backend/js/cropper_dropzone.js') }}"></script>
