                ...
                <div class="calculator-page__inner">
                    <div class="calculator-page__input">
                        <form>
                            ...
                            <div class="calculator-page__input-item">
                                <label>Диаметр поршня</label>
                                <div>
                                    <input type="text" placeholder="100 000"> <span>мм</span>
                                </div>
                            </div>
                            <div class="calculator-page__input-item">
                                <label>Диаметр штока</label>
                                <div>
                                    <input type="text" placeholder="100 000"> <span>мм</span>
                                </div>
                            </div>
                            <div class="calculator-page__input-item">
                                <label>Диаметр хода</label>
                                <div>
                                    <input type="text" placeholder="100 000"> <span>мм</span>
                                </div>
                            </div>
                            <div class="calculator-page__input-item">
                                <label>Расход масла</label>
                                <div>
                                    <input type="text" placeholder="100 000"> <span>л/мин</span>
                                </div>
                            </div>
                            <div class="calculator-page__input-item">
                                <label class="calculator-page__label">Время выдвижения</label>
                                <div>
                                    <input type="text" placeholder="100 000"> <span>с</span>
                                </div>
                            </div>
                            <div class="calculator-page__input-item">
                                <label class="calculator-page__label">Скорость выдвижения</label>
                                <div>
                                    <span class="s-number">100 000</span> <span>м/с</span>
                                </div>
                            </div>
                            <div class="calculator-page__input-item">
                                <label>Давление</label>
                                <div>
                                    <input type="text" placeholder="100 000"> <span>бар</span>
                                </div>
                            </div>
                            <div class="calculator-page__input-item">
                                <label>Усиление выдвижения</label>
                                <div>
                                    <input type="text" placeholder="100 000"> <span>кг</span>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="calculator-page__conclusion">
                        ...
                        <div class="calculator-page__summ">
                            Расчетная мощность привода: <span>0.02 кВ</span>
                        </div>
                    </div>
                </div>
            </div>
