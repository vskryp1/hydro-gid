                    ...
                    <td valign="top">
                        ...
                        <p style="margin: 15px 0;">
                            <span style="font-family: Arial; font-size: 16px; line-height: 18px; letter-spacing: 0.15px; color: #21283D; margin-right: 10px;">
                                @lang('mails.your_order_number'):</span>
                            <a style="text-decoration: none; padding: 5px 15px; background-color: #FF9B00; display: inline-block; font-family: Arial; font-size: 20px; line-height: 23px; align-items: center; color: #21283D;" href="{{ route('frontend.page', PageAlias::PAGE_ACCOUNT) }}">
                                #{{ $order->unique_id }}
                            </a>
                        </p>
                    </td>
