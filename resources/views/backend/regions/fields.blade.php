        ...
        <div class="tab-pane fade active in" id="base" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group">
                        <label for="active">@lang('backend.is_active')</label><br>
                        {!! Form::hidden('is_active', 0) !!}
                        {!! Form::checkbox('is_active', 1, null, ['id' => 'active', 'class' => 'js-switch']) !!}
                    </div>
                    <div class="form-group">
                        <label for="default">@lang('backend.is_default')</label><br>
                    ...
                    @foreach(Setting::get('locales') as $lang => $locale)
                        <div class="tab-pane fade @if($loop->first) in active @endif" id="locales-{{ $lang }}"
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text($lang . '[name]', $region->{'name:' . $lang} ?? null, [
                                    'class'       => 'form-control',
...
@include('backend.elements.save_buttons', ['back_link' => route('backend.settings.regions.index')])