                    ...
                    @foreach(Setting::get('locales') as $lang => $locale)
                        <div class="tab-pane fade @if ($loop->first)in active @endif"
                            ...
                            <div class="form-group">
                                ...
                                @isset($slider_item)
                                    ...
                                    <div class="text-center">
                                        <img src="{{$slider_item->getLocaleUrl($lang) }}" width="250px">
                                    </div>
                                    <br>
                                @endif
                                {!! Form::file($lang . '[image]', ['class'=>'form-control','placeholder'=>__('backend.image'), 'data-validation'=>'required', 'required']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text(
                                    $lang . '[alt]',
                                    old($lang.'.alt')??(isset($slider_item) ? $slider_item->{'alt:'.$lang} : null),
                                    ['class'=>'form-control','placeholder'=>__('backend.alt'), 'data-validation'=>'required', 'required']
                                ) !!}
                            </div>
                            <div class="form-group">
                                ...
                                {!! Form::text(
                                    $lang . '[title]',
                                    old($lang.'.title')??(isset($slider_item) ? $slider_item->{'title:'.$lang} : null),
                                    ['class'=>'form-control','placeholder'=>__('backend.title'), 'data-validation'=>'required', 'required']
                                ) !!}
                            </div>
                            <div class="form-group">
                                ...
                                {!! Form::text(
                                    $lang . '[link]',
                                    old($lang.'.link')??(isset($slider_item) ? $slider_item->{'link:'.$lang} : null),
                                    ['class'=>'form-control','placeholder'=>__('backend.link'), 'data-validation'=>'required', 'required']
                                ) !!}
                            </div>
                            <div class="form-group">
                                <label>@lang('backend.name')</label>
                                {!! Form::text(
                                    $lang . '[name]',
                                    old($lang.'.name')??(isset($slider_item) ? $slider_item->{'name:'.$lang} : null),
                                    ['class'=>'form-control','placeholder'=>__('backend.name')]
                                ) !!}
                            </div>
                            <div class="form-group">
                                ...
                                {!! Form::text(
                                    $lang . '[description]',
                                    old($lang.'.description')??(isset($slider_item) ? $slider_item->{'description:'.$lang} : null),
...
@include('backend.elements.save_buttons', ['back_link' => route('backend.sliders.edit', ['slider' => $slider]).'#slider_items'])
