                ...
                <div class="col-md-6 col-md-offset-3">
                    <div>
                        ...
                        {{--<div class="form-group">--}}
                            ...
                            {{--{!! Form::number('original_price', null, ['class'=>'form-control', 'min' => 0, 'step' => '0.01' , 'required', "data-validate-length-range"=>"6"]) !!}--}}
                        {{--</div>--}}
                        {{--<div class="checkbox">--}}
                        {{--{!! Form::checkbox('is_default', 1, null, ['class' => 'js-switch']) !!}--}}
                        {{--@lang('backend.default')--}}
                        {{--</div>--}}
                        <div class="checkbox">
                            {!! Form::checkbox('is_active', 1, null, ['class' => 'js-switch']) !!}
                            @lang('backend.active')
                        </div>
                    </div>
                </div>
                    ...
                    @foreach(Setting::get('locales') as $lang => $locale)
                        <div class="tab-pane fade @if ($loop->first)in active @endif"
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text(
                                    $lang . '[name]',
                                    old($lang.'.name')??(isset($delivery_place) ? $delivery_place->{'name:'.$lang} : null),
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea(
                                    $lang . '[description]',
                                    old($lang.'.description')??(isset($delivery_place) ? $delivery_place->{'description:'.$lang} : null),
...
@include('backend.elements.save_buttons', ['back_link' => route('backend.deliveries.edit', ['delivery' => $delivery]).'#delivery_places'])
