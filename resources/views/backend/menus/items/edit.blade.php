...
@section('title', __('backend.menu_items_edit'))

@section('content')
    <div class="panel panel-default user-panel panel-flat">
        <div class="panel-body">
            {!! Form::model($menu_item, [
                'url' => route('backend.menus.menu_items.update',
            ...
            @include('backend.elements.save_buttons', [
                'back_link' => route('backend.menus.edit', ['menu' => $menu]).'#menu_items',
                'destroy_link' => route('backend.menus.menu_items.destroy', ['menu'=> $menu, 'menu_item' => $menu_item]),
                'permission'      => 'menus',
            ])
            {!! Form::close() !!}
        </div>
