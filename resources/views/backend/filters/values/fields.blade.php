                ...
                <div class="col-md-6 col-md-offset-3">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::number('position', old('position')??null, ['class'=>'form-control', 'required']) !!}
                        </div>
                        <div class="checkbox">
                    ...
                    @foreach(Setting::get('locales') as $lang => $locale)
                        <div class="tab-pane fade @if ($loop->first)in active @endif"
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text(
                                    $lang . '[name]',
                                    old($lang.'.name') ?? (isset($filter_value) ? $filter_value->{'name:'.$lang} : null),
                                    ['class'=>'form-control','placeholder'=>__('backend.name').' '.$lang, 'data-validation'=>'required', 'required']
                                ) !!}
                            </div>
                        </div>
                    @endforeach
...
@include('backend.elements.save_buttons', ['back_link' => route('backend.filters.edit', ['filter' => $filter]).'#value'])
