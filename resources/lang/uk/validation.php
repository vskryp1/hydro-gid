<?php
    ...
    return [
        ...
        */
        ...
        'digits_between'       => 'Довжина цифрового поля: attribute повинна бути цілим числом між: min і: max.',
        ...
        'required_unless'      => "Поле є обов'язковим для заповнення.",
        'required_with'        => "Поле є обов'язковим для заповнення.",
        'required_with_all'    => "Поле є обов'язковим для заповнення.",
        'required_without'     => "Поле є обов'язковим для заповнення.",
        'required_without_all' => "Поле є обов'язковим для заповнення.",
