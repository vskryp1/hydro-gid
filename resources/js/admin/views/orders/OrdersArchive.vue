<template>
    <div class="h-100 d-flex flex-column" style="min-height: 78vh;">
    <!--      Filters  -->
    ...
    export default {
        ...
        methods: {
            ...
            getData(q = {}){
                ...
                this.loading = true;
                axios.get(this.$store.state.path+'orders/archived',{ params: this.query })
                    .then(response => {
                        this.loading = false;
            ...
            destroy(){
                ...
                axios.delete(this.$store.state.path+'orders/force/'+this.deleteItem.id)
                    .then(response => {
                        this.getData({page: this.paginate.current_page})
