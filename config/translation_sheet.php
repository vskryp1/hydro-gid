<?php
    ...
    return [
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        'serviceAccountCredentialsFile' => env('TS_SERVICE_ACCOUNT_CREDENTIALS_FILE',
            base_path('resources/google/service-account-crendentials.json')),
