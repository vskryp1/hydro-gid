    ...
    return [
        ...
        */
        ...
        'hooks' => [
            ...
            'ready'   => [
                ...
                'google:link',
                'supervisor:restart',
                'artisan vendor:publish:lfm_public'
                //                'fpm:reload',
            ],
        ...
        */
        ...
        'options' => [
            ...
            'repository'       => getenv('CI_REPOSITORY_URL'),
            ...
            'writable_dirs', [
                ...
                'storage/logs',
                'resources/lang',
                'resources/view/frontend/templates',
                'resources/view/frontend/mails',
                'resources/mails/',
            ],
            'php_fpm_service'  => 'php7.2-fpm',
            'http_user'        => getenv('SSH_USER'),
        ],
        ...
        */
        ...
        'hosts' => [
            getenv('DOMAIN') => [
                'deploy_path' => getenv('SERVER_PATH'),
