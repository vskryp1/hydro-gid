<?php
    ...
    class PrivatPayParts
    {
        ...
        public function setOptions(array $options)
        {
            if (empty($options) || !is_array($options)) {
                ...
                foreach ($options as $PPOptions => $value) {
                    if (method_exists('App\Helpers\PrivatPayParts', "set$PPOptions")) {
        ...
        public function create($method = 'pay')
        {
            if ($this->options['SUCCESS']) {
                ...
                if(isset($CreateResult['message'])) {
                    $checkSignature[] = $CreateResult['message'];
                }
        ...
        /*
         * Transform orderId from Callback
         * PREFIX-3196fa3007bc4b6dab8 to 3196fa3007bc4b6dab8
         *
         * @param $orderId
         */
        public function getOrderId($orderId)
        {
            return substr(strstr($orderId, '-'), 1, strlen($orderId));
        }
    }
