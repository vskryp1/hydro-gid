...
class FeedGeneratorCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'merchant:feed';
     ...
     * @var string
     */
    protected $description = 'Generate merchant_feed.xml file';
